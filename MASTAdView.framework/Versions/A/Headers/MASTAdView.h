...
#import "MASTDotAndAdDescriptor.h"


@class MASTAdView;
//FIX FOR DOTANDAD
@class DotAndAdConfigMpt;
...
@optional
//FIX FOR DOTANDAD
- (void)MASTAdViewWillHide:(MASTAdView *)adView;
- (void)MASTAdViewDidHide:(MASTAdView *)adView;
- (void)MASTAdViewCloseAdByNoAdv:(MASTAdView *)adView;
...
//FIX FOR DOTANDAD
@property(nonatomic, retain) DotAndAdConfigMpt* _configMpt;
@property(nonatomic, retain) MASTAdView* senderAdView;
...
@property(nonatomic, retain) NSDate *pauseStart, *previousFireDate;
@property(nonatomic, retain) UIViewController* parentViewController;
@property(nonatomic, retain) UIView* parentView;
@property(nonatomic, retain) NSTimer* timer;
@property(nonatomic, retain) DotAndAdConfigMpt* configMpt;
@property(nonatomic, retain) NSURL* url;
@property(nonatomic, retain) NSString* currentMpt;

+(MASTAdView*) initWithMpt: (DotAndAdConfigMpt*) configMpt andParentView:(UIView*)parentView andCurrentMpt:(NSString*)mpt;
 ...
 */
- (void)renderWithAdDescriptor:(MASTDotAndAdDescriptor*)adDescriptor;
